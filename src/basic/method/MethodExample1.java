...
public class MethodExample1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("calcTotal(100) = " + calcTotal(100));
        System.out.println("calcTotal(200) = " + calcTotal(200));
        System.out.println("calcTotal(300) = " + calcTotal(300));
        System.out.println("calcTotal(400) = " + calcTotal(400));
        System.out.println("calcTotal(500) = " + calcTotal(500));
        System.out.println("calcTotal(600) = " + calcTotal(600));
        System.out.println("calcTotal(700) = " + calcTotal(700));
        System.out.println("calcTotal(800) = " + calcTotal(800));
        System.out.println("calcTotal(900) = " + calcTotal(900));
