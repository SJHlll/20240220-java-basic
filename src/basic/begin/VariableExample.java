...
public class VariableExample {
    ...
    public static void main(String[] args) {
        ...
        // 처음 만들 떄 한번만 가능하다 (데이터 타입이 앞에 붙은 것은 새롭게 선언한다는 것을 의미함)
        int score = 90;
        // int score = 95; (x)
        ...
        // int count = "ㅎㅇ"; (x)    int -> 문자 안됨
        // int count = 23.5; (x)     int -> 소수 안됨
        // String str = 100; (x)  String -> 숫자 안됨

        // 변수는 자료형(데이터 타입)이 달라도 이름이 동일하면 중복 선언이 안된다
        String name = "홍길동";
        // int name = 1004; (x)

        // 선언 및 초기화하지 않은 변수는 사용이 불가능하다
        // int result = myScore + num; (x) / 변수 num 을 선언한 적이 없음

        // int result;
        // System.out.println("result = " + result); (x) / 초기화가 필요함
