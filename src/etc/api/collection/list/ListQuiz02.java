...
//        User hong = new User("ㅎㄱㄷ",10);
//        User kim = new User("ㄱㅈㅅ",14);
//        User park = new User("ㅂㅇㅅ",18);
//        userList.add(hong);
//        userList.add(kim);
//        userList.add(park);
//
//        userList.add(new User("홍길동",24));
//        userList.add(new User("김철수",27));
//        userList.add(new User("이영희",30));
