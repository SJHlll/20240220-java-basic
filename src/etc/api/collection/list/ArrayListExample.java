...
//        String name = nick[3]; (x) 배열의 방법
        ...
        System.out.println(nick.contains("크아악"));

        // indexOf(객체) : 특정 객체의 인덱스 탐색
        int idx = nick.indexOf("개굴");
        System.out.println("개굴의 인덱스 = " + idx);

        // clear() : 리스트 내부의 요소를 전부 삭제
        nick.clear();
        ...
        /*
            # 컬렉션 객체들은 Collection의 기능을 사용할 수 있다
        ...
        // 한번에 객체 많이 추가하기
        Collections.addAll(score,70, 100, 20, 100, 30, 50, 100);
