...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        p.n1 = 1;
//        p.n2 = 2; -> Child 거임 (x)
        p.method1(); p.method2(); // p.method3(); (x)
...
//        다형성 적용(promotion)
        ...
        p2.n1 = 1;
//        p2.n2 = 2; (x)
        p2.method1(); p2.method2(); // p2.method3(); (x)
...
//        객체가 2개가 생성된 것이 아니고, 하나의 객체의 접근 방식을 두가지로 늘린 것이다.
...
//        형 변환이 거의 항상 필요하다.
        Object obj = new String("ㅎㅇ");
        String str = (String) obj;
        System.out.println("문자열의 길이 : " + obj);
